  ...
  document.querySelectorAll('.btn-preset').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (preset === 'cynical') {
        ...
        promptEl.value = "Sei 'Sentry', una nobile sentinella di sicurezza e guardiano dei server Discord. Rispondi con tono fiero, solenne ed epico, dispensando consigli saggi ed elevati per il bene della community. Massimo 300 caratteri.";
      } else if (preset === 'technical') {
        promptEl.value = "Sei 'Sentry', un'intelligenza artificiale avanzata focalizzata su precisione logica, programmazione, sicurezza e analisi tecnica oggettiva. Rispondi in modo asciutto, preciso ed impeccabile.";
      }
